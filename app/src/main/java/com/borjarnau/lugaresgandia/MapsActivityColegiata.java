...
public class MapsActivityColegiata extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_activity_colegiata);
  ...
  /*  public void onMapReady(GoogleMap googleMap) {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(
                new LatLng(38.96702520892197, -0.18026606586611926), 14));

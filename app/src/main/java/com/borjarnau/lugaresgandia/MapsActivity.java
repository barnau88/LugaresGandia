...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
   ...
   /* public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng palacio = new LatLng(38.96584066965646, -0.18012927320635974);
        mMap.addMarker(new MarkerOptions().position(palacio).title("Marker in Palacio Ducal Gandia"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(palacio));
    }
    */
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(
                new LatLng(38.96584066965646, -0.18012927320635974), 14));
        ...
        mMap.addMarker(new MarkerOptions()
                ...
                .position(new LatLng(38.96584066965646, -0.18012927320635974)));            //PALACIO
